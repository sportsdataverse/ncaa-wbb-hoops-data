...
Equivalent to::
    ...
    python -m ncaa_wbb_data_build build --dataset matchup_stints --season <year>
"""
...
if __name__ == "__main__":
    ...
    # 09 build something other than matchup_stints.
